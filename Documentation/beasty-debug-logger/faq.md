...
[Release builds](guides/release-builds.md). Read that page before you scatter log calls through a hot loop.
...
System, see [Working with the other Beasty packages](guides/beasty-integration.md).
...
- write a thin static facade over the API that prefixes your own tag and holds your own switches, and log
  ...
  [Logging](guides/logging.md) and [Working with the other Beasty packages](guides/beasty-integration.md).
...
without them. See [The Beasty Console window](guides/console-window.md).
