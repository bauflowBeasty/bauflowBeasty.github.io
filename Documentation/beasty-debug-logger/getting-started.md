...
- [Logging](guides/logging.md) — the eleven levels, and when to reach for each one.
- [The Beasty Console window](guides/console-window.md) — every control, and the behaviours that surprise
  people.
