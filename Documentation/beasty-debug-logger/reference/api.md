...
must be set after startup. See [Release builds](../guides/release-builds.md).
...
[The Beasty Console window](../guides/console-window.md).

## See also

- [Logging](../guides/logging.md)
- [Release builds](../guides/release-builds.md)
