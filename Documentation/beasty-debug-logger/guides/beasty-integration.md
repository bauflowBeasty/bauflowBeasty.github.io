...
[Beasty Visual Novel](../../beasty-visual-novel/README.md) references this logger directly and logs through
...
`VNLog` sits on top of `BeastyDebugLogger`, so `IsEnabled` still applies: switching the logger off silences
the VN too.

## Beasty Save System

[Beasty Save System](../../beasty-save-system/README.md) does **not** reference this logger. It looks for it
...
- [Beasty Visual Novel](../../beasty-visual-novel/README.md)
