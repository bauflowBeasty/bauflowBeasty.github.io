...
`BeastySave.SaveAsync` on it. See [Scene state](scene-state.md).
...
- [BeastySave API](../reference/api-beastysave.md) — every method on the facade, sync and async
- [Results and errors](../reference/results-and-errors.md) — what to check on the result
- [Slots and metadata](slots-and-metadata.md) — the `meta` argument `SaveAsync` also takes
- [Platforms and limits](../advanced/platforms-and-limits.md) — where the package runs, and how fast
