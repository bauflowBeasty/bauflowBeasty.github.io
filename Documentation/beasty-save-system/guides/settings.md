...
- **This is obfuscation, not security.** Read [encryption.md](encryption.md) before you rely on it.
...
Set your own key before you ship. Then read [encryption.md](encryption.md), which is honest about the fact
...
default is on for a good reason. See [backups-and-corruption.md](backups-and-corruption.md).
...
roots, is in [strict-vs-tolerant.md](strict-vs-tolerant.md).
...
See [versioning-and-migrations.md](versioning-and-migrations.md).
...
- [encryption.md](encryption.md) — the honest limits
- [backups-and-corruption.md](backups-and-corruption.md) — the `.bak` file and how to restore it
- [strict-vs-tolerant.md](strict-vs-tolerant.md) — the two loading modes
- [versioning-and-migrations.md](versioning-and-migrations.md) — `DataVersion` in practice
- [slots-and-metadata.md](slots-and-metadata.md) — listing slots and reading their metadata
- [results-and-errors.md](../reference/results-and-errors.md) — every error code
