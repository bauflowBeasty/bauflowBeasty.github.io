...
in [converter-modules.md](../reference/converter-modules.md). Read it before you rely on one. Some of the
...
- [converter-modules.md](../reference/converter-modules.md) — exactly which fields each built-in converter stores
- [custom-converters.md](../advanced/custom-converters.md) — teaching the system a type it does not know
- [strict-vs-tolerant.md](../guides/strict-vs-tolerant.md) — what happens when one field cannot be read back
- [results-and-errors.md](../reference/results-and-errors.md) — every error code
- [scene-state.md](scene-state.md) — saving the scene rather than your own class
