...
If you have not built the basic setup yet, [save-without-code.md](../getting-started/save-without-code.md)
...
[save-without-code.md](../getting-started/save-without-code.md).
...
[backups-and-corruption.md](backups-and-corruption.md).
...
([converter-modules.md](../reference/converter-modules.md)), or write a converter for it
([custom-converters.md](../advanced/custom-converters.md)).

## See also

- [save-without-code.md](../getting-started/save-without-code.md) — the click-by-click setup
- [save-manager-window.md](save-manager-window.md) — the editor window
- [components.md](../reference/components.md) — `BeastySaveable` and `BeastySaveManager`, field by field
- [what-gets-saved.md](what-gets-saved.md) — which fields and types round-trip
- [converter-modules.md](../reference/converter-modules.md) — what each converter stores
- [strict-vs-tolerant.md](strict-vs-tolerant.md) — what a scene load does when one component fails
