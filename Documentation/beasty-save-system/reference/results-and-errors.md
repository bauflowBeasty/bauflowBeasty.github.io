...
Unity object reference. Nothing was written. See [What gets saved](../guides/what-gets-saved.md).
...
settings objects. See [Encryption](../guides/encryption.md).
...
[Converter modules](converter-modules.md) and [Custom converters](../advanced/custom-converters.md).
...
`Warnings` instead of failing the load. See [Strict vs tolerant loading](../guides/strict-vs-tolerant.md).

## See also

- [BeastySave API](api-beastysave.md)
