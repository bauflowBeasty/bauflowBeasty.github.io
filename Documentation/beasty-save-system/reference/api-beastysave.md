...
[Save file format](save-file-format.md). Returns `SaveResult.Ok()` or a failure.
...
calling thread. Same error codes. See [Async saving](../guides/async-saving.md).
...
> [Strict vs tolerant loading](../guides/strict-vs-tolerant.md).
...
should call. See [Slots and metadata](../guides/slots-and-metadata.md).
...
is safe. See [Backups and corruption](../guides/backups-and-corruption.md).
...
`ArgumentNullException` on a null sequence. See [Custom converters](../advanced/custom-converters.md).
...
- [Save file format](save-file-format.md)
