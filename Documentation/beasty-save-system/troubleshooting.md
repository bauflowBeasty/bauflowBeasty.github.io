...
The full list of codes is in [Results and errors](reference/results-and-errors.md).
...
[What gets saved](guides/what-gets-saved.md) and [Converter modules](reference/converter-modules.md).
...
See [Scene state](guides/scene-state.md).
...
carried the id with it. See [Scene state](guides/scene-state.md).
...
- **Enable the module.** Each module needs its Unity package present in the project (for example the
  ...
  itself. See [Converter modules](reference/converter-modules.md).
- **Untick the component.** If you did not need its state saved, take it out of the list.
- **Write a converter.** See [Custom converters](advanced/custom-converters.md).
...
[Backups and corruption](guides/backups-and-corruption.md).
...
this before you ship, not after. See [Encryption](guides/encryption.md).
...
`LoadCompleted`. See [Results and errors](reference/results-and-errors.md) and
...
serialized at all. See [Converter modules](reference/converter-modules.md).
...
keep working. See [Custom converters](advanced/custom-converters.md).
...
persistence layer. See [Platforms and limits](advanced/platforms-and-limits.md).
...
See [Results and errors](reference/results-and-errors.md) for the complete list of the thirteen codes and
[Strict vs tolerant loading](guides/strict-vs-tolerant.md) for the difference the `Strict` setting makes.

## See also

- [What gets saved](guides/what-gets-saved.md)
- [Scene state](guides/scene-state.md)
- [Backups and corruption](guides/backups-and-corruption.md)
- [Encryption](guides/encryption.md)
- [Versioning and migrations](guides/versioning-and-migrations.md)
- [The Save Manager window](guides/save-manager-window.md)
- [FAQ](faq.md)
