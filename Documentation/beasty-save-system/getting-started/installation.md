...
- [save-without-code.md](save-without-code.md) — a working save and load, writing no C#.
- [save-with-code.md](save-with-code.md) — the same thing from a script, in five minutes.
...
[converter-modules.md](../reference/converter-modules.md) for exactly which fields each module stores, and
[custom-converters.md](../advanced/custom-converters.md) for teaching the system a type it does not know.
...
[platforms-and-limits.md](../advanced/platforms-and-limits.md).

## See also

- [save-without-code.md](save-without-code.md)
- [save-with-code.md](save-with-code.md)
- [what-gets-saved.md](../guides/what-gets-saved.md)
