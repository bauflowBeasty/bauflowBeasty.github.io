...
stall, not off the serialization work. See [Async saving](../guides/async-saving.md).
...
not security. The key ships inside your game. See [Encryption](../guides/encryption.md).
...
- [Installation](../getting-started/installation.md) — requirements and what is in the folder.
- [Async saving](../guides/async-saving.md) — what `SaveAsync` really does.
- [Encryption](../guides/encryption.md) — the honest limits.
- [What gets saved](../guides/what-gets-saved.md) — supported types and hard errors.
- [The save file format](../reference/save-file-format.md) — the envelope and the write pipeline.
