...
> next to running the validator. See [Building and platforms](building-and-platforms.md).

## See also

- [Large projects](large-projects.md) — when streaming is worth turning on, and what else to do first.
- [Building and platforms](building-and-platforms.md) — the pre-build checklist.
