...
every caller and each caller decides what happens afterwards. See [Subgraphs](../authoring/subgraphs.md).
...
things start behaving oddly. See [Validation and ids](validation-and-ids.md).

## See also

- [Streaming](streaming.md), [Validation and ids](validation-and-ids.md), [Localization](localization.md).
- [Subgraphs](../authoring/subgraphs.md) and [Transitions](../authoring/transitions.md) — reuse, and moving
  between scenes and modes.
- [The text script](../authoring/text-script.md) — writing a scene as text, which scales differently from the
  canvas.
