...
- [VN settings](vn-settings.md) — text speed, auto-forward and the other preference ranges.
- [UI prefabs](ui-prefabs.md) — the preferences screen the player rebinds from.
- [Saving and loading](saving-and-loading.md) — what quick save and quick load do.
