...
![The Hierarchy after Create Scene: BeastyManager, Stage, Canvas, Main Camera, EventSystem](../images/vn-first-scene-hierarchy.png)
...
[Core concepts](core-concepts.md) afterwards.
...
Full detail: [Characters](../world/characters.md).
...
![The Story tab: the Add blocks palette, the graph, and the node inspector with four blocks](../images/vn-story-tab-first-node.png)

> **Note**
> Leave the **Speaker** field empty and the line is narration — no name, no portrait. That is how you
> write "The room went quiet."

Full detail: [Dialogue and the stage](../authoring/dialogue-and-stage.md) and
...
Full detail: [Choices and decisions](../authoring/choices-and-decisions.md).
...
**Save** and **Load** already work. See [Input and controls](../production/input-and-controls.md).
...
[Dialogue preview](../authoring/dialogue-preview.md).
...
FreeRoam** block at the end of a node and read [Free roam rooms](../world/free-roam-rooms.md).
...
says so. Read [Variables and conditions](../world/variables-and-conditions.md).
...
[The text script](../authoring/text-script.md).

## See also

- [Core concepts](core-concepts.md) — read this next
- [Editor tour](editor-tour.md)
- [The story graph](../authoring/story-graph.md)
- [Blocks reference](../authoring/blocks-reference.md)
