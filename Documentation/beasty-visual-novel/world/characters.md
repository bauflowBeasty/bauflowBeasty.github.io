...
say — that is [Dialogue and stage](../authoring/dialogue-and-stage.md).
...
![The Characters tab, Cast sub-tab, with a character selected](../images/vn-characters-cast.png)
...
[Validation and ids](../production/validation-and-ids.md).
...
[Variables and conditions](variables-and-conditions.md).
...
they are is decided by the room prefab, not here — see [Character routines](character-routines.md).
...
[Variables and conditions](variables-and-conditions.md#shared-conditions-and-self), and the screens
themselves in [Character screens](character-screens.md).
...
automatically. See [The talk menu](talk-menu.md).

## See also

- [Variables and conditions](variables-and-conditions.md) — the store every character variable lives in
- [Character screens](character-screens.md) — the cast list, the profile, the stats screen
- [The talk menu](talk-menu.md) — the per-character conversation hub
- [Dialogue and stage](../authoring/dialogue-and-stage.md) — putting a character on stage and making them speak
- [Blocks reference](../authoring/blocks-reference.md) — every block, by category
