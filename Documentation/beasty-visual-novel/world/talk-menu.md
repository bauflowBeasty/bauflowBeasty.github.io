...
A **GatherDeliver** objective ([Quests](quests.md)) is completed by giving the items to the quest's owner, and
...
click first. See [Interactables and doors](interactables-and-doors.md) and
...
- [Quests](quests.md) — talk steps, GatherDeliver objectives, delivery timing.
- [Interactables and doors](interactables-and-doors.md) — the Talk menu action and character poses.
- [Character routines](character-routines.md) — where the character is standing when the player wants to talk.
- [Characters](characters.md) — the cast, and each character's definition.
- [Localization](../production/localization.md) — the table the labels and the prompt come from.
