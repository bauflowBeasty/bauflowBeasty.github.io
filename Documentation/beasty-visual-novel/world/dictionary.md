...
localization tables described in [Localization](../production/localization.md). The dictionary is the one
thing that does not.
...
nothing to make that happen. See [Variables and conditions](variables-and-conditions.md#the-store).
...
- [Variables and conditions](variables-and-conditions.md) — the store both of them live in
- [Localization](../production/localization.md) — what does get translated, and how
- [Blocks reference](../authoring/blocks-reference.md) — the Set dictionary and Ask blocks
- [.vnbeasty syntax](../authoring/vnbeasty-syntax.md) — `dict` and `ask dict` in the text script
