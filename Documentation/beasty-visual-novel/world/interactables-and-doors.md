...
| **Talk menu** | Open a character's [talk menu](talk-menu.md). Only offered on an object that has an owner character. |
...
- **Tint** uses the global highlight colour from [VN Settings](../production/vn-settings.md) unless you tick
...
[talk menu](talk-menu.md) when she has one. See [Character routines](character-routines.md).
...
[Advance time](game-time.md) block inside that scene:
...
- [Free-roam rooms](free-roam-rooms.md) — the map, rooms, room prefabs, conditional backgrounds.
- [Talk menu](talk-menu.md) — what clicking a character opens.
- [Character routines](character-routines.md) — who is standing in the room.
- [Game time](game-time.md) — the Advance time operations in full.
