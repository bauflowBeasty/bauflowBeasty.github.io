...
like a choice's logic. See [Variables and conditions](variables-and-conditions.md).
...
[Choices and decisions](../authoring/choices-and-decisions.md) and
[Interactables and doors](interactables-and-doors.md).
...
[UI prefabs](../production/ui-prefabs.md).
...
back to the room. See [Screens and HUD](screens-and-hud.md).

## See also

- [Variables and conditions](variables-and-conditions.md) — `item.<id>` and the store it lives in
- [Quests](quests.md) — gather-and-deliver objectives and the Deliver items block
- [Screens and HUD](screens-and-hud.md) — HUD buttons, overlays and the screen stack
- [UI prefabs](../production/ui-prefabs.md) — restyling the inventory
- [Gameplay APIs](../scripting/gameplay-apis.md) — the `Inventory` API for programmers
