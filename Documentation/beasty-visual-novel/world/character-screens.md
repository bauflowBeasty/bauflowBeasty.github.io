...
[Characters](characters.md#appearing-in-the-cast-list)):
...
[Characters](characters.md#character-variables-stats).
...
routine rules you authored — see [Character routines](character-routines.md) — not a second copy of them,
...
this character from here. See [Quests](quests.md).
...
back to the cast list. See [Screens and HUD](screens-and-hud.md).

## See also

- [Characters](characters.md) — the settings behind every screen on this page
- [Screens and HUD](screens-and-hud.md) — the screen stack, HUD buttons and overlays
- [Character routines](character-routines.md) — the schedule the calendar shows
- [Quests](quests.md) — quests, objectives and hints
- [UI prefabs](../production/ui-prefabs.md) — restyling these screens and upgrading them safely
