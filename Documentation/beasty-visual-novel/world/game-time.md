...
[character routines](character-routines.md), conditional room backgrounds, recurring quests and any condition
...
- or a call from your own code (see [Gameplay APIs](../scripting/gameplay-apis.md)).
...
See [Interactables and doors](interactables-and-doors.md).

### From a HUD button

A screen item whose action is **AdvanceTime** does the same from the HUD. See
[Screens and HUD](screens-and-hud.md).
...
(`maya.location`, `maya.spot`, `maya.routineMode`) — see [Character routines](character-routines.md).
...
- [Character routines](character-routines.md) — putting characters where they belong at each daypart.
- [Quests](quests.md) — Daily, Weekly and SpecificDays quests, and WaitTime objectives.
- [Variables and conditions](variables-and-conditions.md) — how conditions are built.
- [Gameplay APIs](../scripting/gameplay-apis.md) — `BeastyTime` for programmers.
