...
thing for a [dictionary token](dictionary.md) and for a
[character's displayed name](characters.md#aliases-showing-a-different-name).
...
blocks at all. See [Choices and decisions](../authoring/choices-and-decisions.md).
...
[Character screens](character-screens.md).
...
[Generated accessors](../scripting/generated-accessors.md), and
[Gameplay APIs](../scripting/gameplay-apis.md) for the time, routine, quest and inventory facades.

## See also

- [Core concepts](../getting-started/core-concepts.md) — project, context, graph, node, block
- [Variable keys](../reference/variable-keys.md) — every reserved key namespace
- [Characters](characters.md) — character variables and the schema
- [The dictionary](dictionary.md) — player-editable text tokens
- [Choices and decisions](../authoring/choices-and-decisions.md) — where conditions and effects do most of their work
