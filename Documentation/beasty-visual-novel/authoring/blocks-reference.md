...
Covered in depth in [Dialogue and the stage](dialogue-and-stage.md).

---

## Scene

Everything in this category is covered in depth in [Dialogue and the stage](dialogue-and-stage.md).
...
[The dictionary](../world/dictionary.md).
...
same screen stack a HUD button uses. See [Screens and HUD](../world/screens-and-hud.md).
...
[Items and inventory](../world/items-and-inventory.md).
...
See [Audio and music](../production/audio-and-music.md).
...
[Transitions](transitions.md). Rooms are covered in [Free roam rooms](../world/free-roam-rooms.md).
...
- [The story graph](story-graph.md) — the canvas and the seven node types.
- [Dialogue and the stage](dialogue-and-stage.md) — the Dialogue and Scene blocks in depth.
- [Choices and decisions](choices-and-decisions.md) — branching.
- [Transitions](transitions.md) — flow blocks versus flow nodes.
- [Variables and conditions](../world/variables-and-conditions.md) — the store everything writes to.
