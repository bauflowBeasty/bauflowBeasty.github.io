...
[.vnbeasty syntax reference](vnbeasty-syntax.md).
...
![The Story tab with the Graph / Text toggle and the script editor](../images/vn-text-tab.png)
...
- [.vnbeasty syntax reference](vnbeasty-syntax.md) — every construct, for lookup.
- [The story graph](story-graph.md) — the canvas and the node types the script compiles into.
- [Blocks reference](blocks-reference.md) — every block, by category.
- [Choices and decisions](choices-and-decisions.md) — conditions, effects and routing in the graph.
- [Subgraphs](subgraphs.md) — nesting a graph and routing its outcome.
- [Variables and conditions](../world/variables-and-conditions.md) — where the names in `set` and `if` come
  from.
- [Localization](../production/localization.md) — the authoring language selector, and where a line's text
  is actually stored.
