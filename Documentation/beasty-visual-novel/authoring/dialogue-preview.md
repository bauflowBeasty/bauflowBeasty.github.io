...
![The Dialogue Preview window showing a node with two characters on stage](../images/vn-dialogue-preview.png)
...
- [The story graph](story-graph.md) — the canvas the preview button lives beside.
- [Dialogue and the stage](dialogue-and-stage.md) — what you are looking at in the preview.
- [Blocks reference](blocks-reference.md) — the blocks whose rows carry the preview button.
