...
a root StoryGraph and a first Dialogue node in one step. See [Menu items](menu-items.md).
...
See [The story graph](../authoring/story-graph.md) and [The text script](../authoring/text-script.md).
...
See [Subgraphs](../authoring/subgraphs.md).
...
Every field is documented in [VN Settings](../production/vn-settings.md).
...
See [Game time](../world/game-time.md).
...
See [Characters](../world/characters.md) and [The talk menu](../world/talk-menu.md).
...
[Free roam rooms](../world/free-roam-rooms.md) and [Character routines](../world/character-routines.md).
...
node asset outside a graph. See [The story graph](../authoring/story-graph.md).
...
See [Variables and conditions](../world/variables-and-conditions.md) and
[Variable keys](variable-keys.md).
