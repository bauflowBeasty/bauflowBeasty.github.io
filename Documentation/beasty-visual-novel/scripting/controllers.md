...
| Advance, rewind, read variables inside a story | the static [`VN`](vn-api.md) API |
...
- `EnterCustom` hands the game to your code. See [Custom mode](custom-mode.md).
...
Unity objects requires it. See [Async saving](../../beasty-save-system/guides/async-saving.md) for what that
actually buys you.
