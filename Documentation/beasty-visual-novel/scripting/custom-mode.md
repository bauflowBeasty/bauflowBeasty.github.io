...
Read [Scene state](../../beasty-save-system/guides/scene-state.md) before you rely on it — in particular, the save
...
- [Scene state (Beasty Save System)](../../beasty-save-system/guides/scene-state.md)
- [What gets saved (Beasty Save System)](../../beasty-save-system/guides/what-gets-saved.md)
