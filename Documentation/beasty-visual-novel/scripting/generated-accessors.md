...
Everything the [VN API](vn-api.md) says applies unchanged, including the important part: these read the ACTIVE
...
or one of the [gameplay APIs](gameplay-apis.md), which already do.
