...
`IsEnabled` is separate, and it silences everything. See [Release builds](/docs/beasty-debug-logger/guides/release-builds/).
...
The full mapping is in the [API reference](/docs/beasty-debug-logger/reference/api/).
...
- [API reference](/docs/beasty-debug-logger/reference/api/)
