...
- [Logging](/docs/beasty-debug-logger/guides/logging/) — the eleven levels, and when to reach for each one.
- [The Beasty Console window](/docs/beasty-debug-logger/guides/console-window/) — every control, and the behaviours that surprise
  people.
