...
[Release builds](/docs/beasty-debug-logger/guides/release-builds/). Read that page before you scatter log calls through a hot loop.
...
System, see [Working with the other Beasty packages](/docs/beasty-debug-logger/guides/beasty-integration/).
...
- write a thin static facade over the API that prefixes your own tag and holds your own switches, and log
  ...
  [Logging](/docs/beasty-debug-logger/guides/logging/) and [Working with the other Beasty packages](/docs/beasty-debug-logger/guides/beasty-integration/).
...
without them. See [The Beasty Console window](/docs/beasty-debug-logger/guides/console-window/).
