...
`DataPath`, `Folder` and `Extension` come from [BeastySaveSettings](/docs/beasty-save-system/guides/settings/). With the defaults, the
...
[Save Manager window](/docs/beasty-save-system/guides/save-manager-window/) can show you a summary of a slot it has no key for.
...
the data, not in the meta. See [Encryption](/docs/beasty-save-system/guides/encryption/).
...
[Backups and corruption](/docs/beasty-save-system/guides/backups-and-corruption/) shows the rest of that flow.

## See also

- [Backups and corruption](/docs/beasty-save-system/guides/backups-and-corruption/) — restoring a damaged slot
- [Settings](/docs/beasty-save-system/guides/settings/) — `Folder`, `Extension`, `DataPath`
- [Encryption](/docs/beasty-save-system/guides/encryption/) — what encryption does and does not cover
- [The Save Manager window](/docs/beasty-save-system/guides/save-manager-window/) — the same slot list, in the editor
- [BeastySave API](/docs/beasty-save-system/reference/api-beastysave/) — every method on the facade
- [The save file format](/docs/beasty-save-system/reference/save-file-format/) — where `meta` sits in the file
