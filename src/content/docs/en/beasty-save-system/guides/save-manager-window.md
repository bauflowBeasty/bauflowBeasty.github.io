...
![The Save Manager window with all three sections](/docs-images/beasty-save-system/save-manager-window.png)
...
- **Two rows with the same id** — a duplicate. The second object is not registered at all and falls out of
  ...
  id was typed by hand. Give one of them a different id. See [scene-state.md](/docs/beasty-save-system/guides/scene-state/).
...
- **A warning** when you tick a component nothing can convert. It says so plainly: `SaveAll` will fail with
  ...
  [converter-modules.md](/docs/beasty-save-system/reference/converter-modules/).
...
[slots-and-metadata.md](/docs/beasty-save-system/guides/slots-and-metadata/).
...
[results-and-errors.md](/docs/beasty-save-system/reference/results-and-errors/).
...
is left in place afterwards, so restoring twice is safe. [backups-and-corruption.md](/docs/beasty-save-system/guides/backups-and-corruption/)
...
- [save-without-code.md](/docs/beasty-save-system/getting-started/save-without-code/) — the window in use, from an empty scene
- [scene-state.md](/docs/beasty-save-system/guides/scene-state/) — ids, spawned objects, and what `SaveAll` actually writes
- [settings.md](/docs/beasty-save-system/guides/settings/) — every field in the Manager section
- [backups-and-corruption.md](/docs/beasty-save-system/guides/backups-and-corruption/) — the `.bak` file and Restore Backup
- [slots-and-metadata.md](/docs/beasty-save-system/guides/slots-and-metadata/) — the metadata behind the slot summaries
