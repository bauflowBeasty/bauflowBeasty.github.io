...
A converter is the answer. See [What gets saved](/docs/beasty-save-system/guides/what-gets-saved/) for the full list of what
...
See [Strict vs tolerant loading](/docs/beasty-save-system/guides/strict-vs-tolerant/).
...
work; see [Converter modules](/docs/beasty-save-system/reference/converter-modules/).
...
- [What gets saved](/docs/beasty-save-system/guides/what-gets-saved/) — what the default path covers, and what it refuses.
- [Converter modules](/docs/beasty-save-system/reference/converter-modules/) — the seven built-in modules and what each stores.
- [Strict vs tolerant loading](/docs/beasty-save-system/guides/strict-vs-tolerant/) — the tolerance your converter must honour.
- [The JSON engine](/docs/beasty-save-system/reference/json-engine/) — `JsonNode`, `JsonMapper`, `JsonParser`, `JsonWriter`.
- [The save file format](/docs/beasty-save-system/reference/save-file-format/) — where the `module` id ends up.
- [Results and errors](/docs/beasty-save-system/reference/results-and-errors/) — `FieldMapFailed`, `TypeUnavailable`.
