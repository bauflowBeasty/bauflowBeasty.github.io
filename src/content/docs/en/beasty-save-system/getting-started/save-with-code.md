...
[what-gets-saved.md](/docs/beasty-save-system/guides/what-gets-saved/) before you design your save class — it is short, and it
...
[settings.md](/docs/beasty-save-system/guides/settings/).
...
- **`result.Warnings`** is an `IReadOnlyList<string>` that fills up in tolerant mode
  ...
  [strict-vs-tolerant.md](/docs/beasty-save-system/guides/strict-vs-tolerant/).
...
background job. [async-saving.md](/docs/beasty-save-system/guides/async-saving/) is precise about it.

## Where to go next

- [what-gets-saved.md](/docs/beasty-save-system/guides/what-gets-saved/) — the rules your data class must live by
- [api-beastysave.md](/docs/beasty-save-system/reference/api-beastysave/) — every method on the facade
- [results-and-errors.md](/docs/beasty-save-system/reference/results-and-errors/) — the 13 error codes, and what to do about each
- [scene-state.md](/docs/beasty-save-system/guides/scene-state/) — saving components in the scene instead of your own class
