...
![The Save Manager window with the Create Beasty Save Manager button](/docs-images/beasty-save-system/save-manager-window-empty.png)
...
curious, [settings.md](/docs/beasty-save-system/guides/settings/) explains all of them.
...
![The Beasty Saveable inspector with the Transform component ticked](/docs-images/beasty-save-system/save-saveable-inspector.png)
...
[converter-modules.md](/docs/beasty-save-system/reference/converter-modules/) to find out why.
...
![A uGUI Button OnClick wired to BeastySaveManager.SaveAll with the slot name slot1](/docs-images/beasty-save-system/save-button-onclick.png)
...
[encryption.md](/docs/beasty-save-system/guides/encryption/) first, because it is honest about what encryption here does and
does not buy you.
...
window puts the old one back. See [backups-and-corruption.md](/docs/beasty-save-system/guides/backups-and-corruption/).
...
[scene-state.md](/docs/beasty-save-system/guides/scene-state/). Read it before you build anything that spawns things.
...
The full rules, and what to do instead, are in [what-gets-saved.md](/docs/beasty-save-system/guides/what-gets-saved/). That is
the most important page in this package. Read it next.

## See also

- [what-gets-saved.md](/docs/beasty-save-system/guides/what-gets-saved/) — what round-trips and what does not
- [scene-state.md](/docs/beasty-save-system/guides/scene-state/) — ids, spawned objects, and the manager in depth
- [save-manager-window.md](/docs/beasty-save-system/guides/save-manager-window/) — every button in the editor window
- [settings.md](/docs/beasty-save-system/guides/settings/) — folder, extension, encryption, backup, strict, version
- [slots-and-metadata.md](/docs/beasty-save-system/guides/slots-and-metadata/) — turning slots into a real save-slot screen
- [save-with-code.md](/docs/beasty-save-system/getting-started/save-with-code/) — the same system, from a script
