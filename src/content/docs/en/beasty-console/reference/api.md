...
Assembly: `Beasty.Console` (runtime, all platforms). It references nothing.
...
must be set after startup. See [Release builds](/docs/beasty-console/guides/release-builds/).
