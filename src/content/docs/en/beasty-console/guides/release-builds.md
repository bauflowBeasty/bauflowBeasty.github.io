...
"this must cost nothing in a release build". See [Logging](/docs/beasty-console/guides/logging/).
...
Beasty Console does not open a file, does not rotate a log, and does not upload anything. It calls
...
See [Logging](/docs/beasty-console/guides/logging/).
