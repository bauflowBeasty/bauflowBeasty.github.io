---
title: "Quests"
description: "The quest catalog: what the player is supposed to be doing, how you check that they did it, and what they get for it. This page is for writers and designers."
---
...
The hand-over itself happens either from the character's [talk menu](/docs/beasty-visual-novel/world/talk-menu/) — an entry appears there
...
a quest log is a hint system, not a spoiler. See [Character screens](/docs/beasty-visual-novel/world/character-screens/).
...
menu. See [Talk menu](/docs/beasty-visual-novel/world/talk-menu/), which owns that idea in full.
...
The period is derived from the game day, so it needs [game time](/docs/beasty-visual-novel/world/game-time/) and it moves only when you
advance time.
...
([game time](/docs/beasty-visual-novel/world/game-time/)), an item `apple` ([items and inventory](/docs/beasty-visual-novel/world/items-and-inventory/)), a character
`ana` with a routine so she is somewhere the player can find her
([character routines](/docs/beasty-visual-novel/world/character-routines/)), and a variable `gold`.
...
- They walk into the bakery and click Ana. Her [talk menu](/docs/beasty-visual-novel/world/talk-menu/) opens — and because the player is now
...
- [Talk menu](/docs/beasty-visual-novel/world/talk-menu/) — where a quest's talk steps show up, automatically.
- [Items and inventory](/docs/beasty-visual-novel/world/items-and-inventory/) — items, counts, the Deliver items block.
- [Character routines](/docs/beasty-visual-novel/world/character-routines/) — quest routine overrides.
- [Character screens](/docs/beasty-visual-novel/world/character-screens/) — the in-game quest log and its hints.
- [Game time](/docs/beasty-visual-novel/world/game-time/) — the day counter that drives recurrence.
- [Gameplay APIs](/docs/beasty-visual-novel/scripting/gameplay-apis/) — `BeastyQuests` for programmers.
