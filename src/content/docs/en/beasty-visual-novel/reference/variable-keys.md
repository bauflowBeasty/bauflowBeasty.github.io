...
The full picture is in [Variables and conditions](/docs/beasty-visual-novel/world/variables-and-conditions/).
...
`advanceTimeOnClick`, or from code. See [Game time](/docs/beasty-visual-novel/world/game-time/).
...
- [Variables and conditions](/docs/beasty-visual-novel/world/variables-and-conditions/) - scopes, effects, the condition editor
- [The .vnbeasty syntax](/docs/beasty-visual-novel/authoring/vnbeasty-syntax/) - writing conditions as text
- [Generated accessors](/docs/beasty-visual-novel/scripting/generated-accessors/) - `VNVars` and `VNChars`, typed keys for C#
- [Gameplay APIs](/docs/beasty-visual-novel/scripting/gameplay-apis/) - reading time, routines, quests and the inventory in code
