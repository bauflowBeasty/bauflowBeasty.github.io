...
[Controllers](/docs/beasty-visual-novel/scripting/controllers/). `PromptVariable` builds the request from the variable's declared type, enum values
...
what [generated accessors](/docs/beasty-visual-novel/scripting/generated-accessors/) exist to prevent.
...
Music channel for a while. See [Audio and music](/docs/beasty-visual-novel/production/audio-and-music/).
