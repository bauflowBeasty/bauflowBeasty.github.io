---
title: "Building and platforms"
description: "What the package needs, where it runs, and what to check before you press Build."
---
...
3. **Rebuild the Addressables content** if you use streaming. A stale catalog means streamed art does not
   resolve. See [Streaming](/docs/beasty-visual-novel/production/streaming/).
4. Check the [localization](/docs/beasty-visual-novel/production/localization/) totals: the validator reports how many translations are missing or
   stale.
...
See [Controllers](/docs/beasty-visual-novel/scripting/controllers/).

## See also

- [Installation](/docs/beasty-visual-novel/getting-started/installation/) — requirements, import, and what is in the folder.
- [Streaming](/docs/beasty-visual-novel/production/streaming/) and [Large projects](/docs/beasty-visual-novel/production/large-projects/).
- [Beasty Save System: platforms and limits](/docs/beasty-save-system/advanced/platforms-and-limits/).
