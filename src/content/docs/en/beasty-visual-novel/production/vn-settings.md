---
title: "VN settings"
description: "The project-wide defaults for the whole game: one asset, edited from two places, read at runtime."
---
...
See [Localization](/docs/beasty-visual-novel/production/localization/) for the startup order and the two tables.
...
See [Building and platforms](/docs/beasty-visual-novel/production/building-and-platforms/) for the aspect-ratio enforcer.
...
- [Localization](/docs/beasty-visual-novel/production/localization/), [Saving and loading](/docs/beasty-visual-novel/production/saving-and-loading/),
  [Building and platforms](/docs/beasty-visual-novel/production/building-and-platforms/).
- [Core concepts](/docs/beasty-visual-novel/getting-started/core-concepts/) — what the context is and why there is one.
