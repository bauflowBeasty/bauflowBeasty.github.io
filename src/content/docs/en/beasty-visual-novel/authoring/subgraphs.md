...
- [The story graph](/docs/beasty-visual-novel/authoring/story-graph/) — the SubGraph Node and the Return Node in the node reference.
- [Choices and decisions](/docs/beasty-visual-novel/authoring/choices-and-decisions/) — conditions and effects, which Return nodes reuse.
- [Transitions](/docs/beasty-visual-novel/authoring/transitions/) — leaving the novel entirely, which is a different thing from a subgraph.
- [Variables and conditions](/docs/beasty-visual-novel/world/variables-and-conditions/) — the store a subgraph's effects write to.
