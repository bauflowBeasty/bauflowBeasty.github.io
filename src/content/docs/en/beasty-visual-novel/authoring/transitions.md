...
back with an outcome ([Subgraphs](/docs/beasty-visual-novel/authoring/subgraphs/)); this one does not come back.
...
- [Free roam rooms](/docs/beasty-visual-novel/world/free-roam-rooms/) — the maps and rooms these exits lead to.
- [Blocks reference](/docs/beasty-visual-novel/authoring/blocks-reference/) — the Flow category.
- [The story graph](/docs/beasty-visual-novel/authoring/story-graph/) — the Flow (Mode Switch) Node.
- [Choices and decisions](/docs/beasty-visual-novel/authoring/choices-and-decisions/) — options and branches.
- [Core concepts](/docs/beasty-visual-novel/getting-started/core-concepts/) — the app modes and the shared variable store.
