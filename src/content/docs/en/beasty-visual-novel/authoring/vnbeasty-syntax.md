...
[The text script](/docs/beasty-visual-novel/authoring/text-script/) first — it covers the editor, the sync rules and the safety contract.
...
[time config](/docs/beasty-visual-novel/world/game-time/).
...
- **The folders listed in [VN Settings](/docs/beasty-visual-novel/production/vn-settings/)** keep names short and unambiguous.
...
- [The text script](/docs/beasty-visual-novel/authoring/text-script/) — the editor, the sync rules, the safety contract and the limits.
- [Blocks reference](/docs/beasty-visual-novel/authoring/blocks-reference/) — the same vocabulary, as blocks in the graph.
- [The story graph](/docs/beasty-visual-novel/authoring/story-graph/) — the node types a script compiles into.
- [Characters](/docs/beasty-visual-novel/world/characters/) — ids, expressions, delivery styles and aliases.
- [Quests](/docs/beasty-visual-novel/world/quests/) — quest ids, stages and objectives.
- [Game time](/docs/beasty-visual-novel/world/game-time/) — dayparts, the clock, and the two time modes.
- [Free-roam rooms](/docs/beasty-visual-novel/world/free-roam-rooms/) — the maps and rooms `freeroam` targets.
