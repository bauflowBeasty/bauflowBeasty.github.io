...
El paquete no referencia nada. Incluye dos assemblies, `Beasty.Console` (runtime, todas las plataformas)
y `Beasty.Console.Editor` (la ventana de consola). No necesita los demás paquetes Beasty, y ellos tampoco
lo necesitan a él. Consulta [Integración con Beasty](/es/docs/beasty-console/guides/beasty-integration/).
...
- [Primeros pasos](/es/docs/beasty-console/getting-started/) — instálalo, escribe un log, abre la consola.
- [Logging](/es/docs/beasty-console/guides/logging/) — cada nivel y cuándo usarlo.
- [La ventana Beasty Console](/es/docs/beasty-console/guides/console-window/) — la ventana, control por control.
- [Builds de lanzamiento](/es/docs/beasty-console/guides/release-builds/) — lo que realmente te cuesta el logging en un juego lanzado.
- [Referencia de la API](/es/docs/beasty-console/reference/api/) — todos los miembros públicos.
- [Preguntas frecuentes](/es/docs/beasty-console/faq/)
