...
![La barra de herramientas de Beasty Console: Clear, Collapse, Clear on Play, Error Pause y el campo de búsqueda](/docs-images/beasty-console/log-console-toolbar.png)
...
`LogCaution` no pausa el editor; consulta [Logging](/es/docs/beasty-console/guides/logging/).
...
![Una fila seleccionada y el panel de detalle debajo, con el mensaje y su stack trace](/docs-images/beasty-console/log-console-detail.png)
...
![Una línea del stack trace dibujada como enlace en el panel de detalle](/docs-images/beasty-console/log-console-stack-link.png)
