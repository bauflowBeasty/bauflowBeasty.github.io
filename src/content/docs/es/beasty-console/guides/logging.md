...
![Una línea de cada nivel en la consola, para comparar colores y glifos](/docs-images/beasty-console/log-levels-sample.png)
...
maestro `IsEnabled` va aparte, y silencia todo. Consulta [Builds de lanzamiento](/es/docs/beasty-console/guides/release-builds/).
...
![Mensajes coloreados logueados sin cambiar de nivel](/docs-images/beasty-console/log-color-sample.png)
...
El mapeo completo está en la [referencia de la API](/es/docs/beasty-console/reference/api/).
...
- [Referencia de la API](/es/docs/beasty-console/reference/api/)
