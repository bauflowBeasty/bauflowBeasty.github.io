...
| Elemento de menú | Qué hace | Más |
|---|---|---|
| `Tools > Beasty VN > Setup > Create Scene` | El asistente. Construye el BeastyManager, el Stage, el Canvas, la Main Camera y el EventSystem, instancia la UI, y luego autoconecta todo. Seguro de volver a ejecutar: reutiliza lo que ya está ahí. | [Tu primera escena](/es/docs/beasty-visual-novel/getting-started/your-first-scene/) |
...
| Elemento de menú | Qué hace | Más |
|---|---|---|
| `Tools > Beasty VN > Content > Create Base Assets (intro + FreeRoam map)` | Crea solo lo que falta y lo conecta. Nunca duplica el context y nunca sobrescribe una referencia que ya asignaste. | [Conceptos fundamentales](/es/docs/beasty-visual-novel/getting-started/core-concepts/) |
...
Ninguno de los dos es necesario para autorar un juego. Existen para que un programador tenga claves
...
| `Assets > Beasty VN > Ensure Room Background Child` | Añade el componente de sala y un hijo de fondo a un prefab de sala hecho a mano, para que puedas soltar el arte de la sala y colocar interactuables contra él. | [Salas de free roam](/es/docs/beasty-visual-novel/world/free-roam-rooms/) |
...
| `Beasty > Beasty Loading Screen` | El overlay de carga mostrado mientras la escena arranca y entre modos. | [Prefabs de UI](/es/docs/beasty-visual-novel/production/ui-prefabs/) |
...
Ver [Solución de problemas](/es/docs/beasty-visual-novel/troubleshooting/).
