...
description: "Tú escribes la historia. Beasty Visual Novel la reproduce. Un motor completo de novela visual para Unity: editor de creación, runtime y cero código."
---
...
tiempo junto al script. El arte se referencia por GUID — el id interno permanente que Unity da a cada
asset — así que renombrar o mover un sprite no rompe un nodo sincronizado.
...
Todo lo que ve el jugador es un prefab estándar de Unity UI (uGUI) que puedes restilizar. Se incluye el
...
autoguardado, las copias de seguridad y el cifrado opcional funcionan de fábrica. Si quieres guardar tus
